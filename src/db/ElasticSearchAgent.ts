...
export class ElasticSearchAgent
    ...
    public getTransaction: (
        hash: H256
    ) => Promise<AssetMintTransactionDoc | AssetTransferTransactionDoc | null>;
    ...
    public getAssetBundlesByAssetName: (
        name: string
    ) => Promise<AssetBundleDoc[]>;
    ...
    public getTotalParcelCountByPlatformAddress: (
        address: string
    ) => Promise<number>;
    public getTotalTransactionCountByAssetType: (
        assetType: H256
    ) => Promise<number>;
    public getTotalTxCountByAssetTransferAddress: (
        address: string
    ) => Promise<number>;
    public getTotalAssetBundleCountByPlatformAddress: (
        address: string
    ) => Promise<number>;
    public getTotalBlockCountByPlatformAddress: (
        address: string
    ) => Promise<number>;
