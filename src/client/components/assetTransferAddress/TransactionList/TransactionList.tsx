                        ...
                        <Col md="5">
                            {
                                _.map(transactionDoc.data.inputs, (input, i) => {
                                    return (
                                        <div key={`input-${i}`} className={`mt-2 mb-2 data-set input-output-container ${AssetTransferAddress.fromPublicKeyHash(new H256(input.prevOut.owner)).value === owner ? "input-highlight" : ""}`}>
                                            <Row>
                                                <Col md="0" />
                                                <Col md="12">
                        ...
                        <Col md="5">
                            {
                                _.map(transactionDoc.data.outputs, (output, i) => {
                                    return (
                                        <div key={`output-${i}`} className={`mt-2 mb-2 data-set input-output-container ${AssetTransferAddress.fromPublicKeyHash(new H256(output.owner)).value === owner ? "output-highlight" : ""}`}>
                                            <Row>
                                                <Col md="0" />
                                                <Col md="12">
