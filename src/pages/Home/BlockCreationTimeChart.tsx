...
type Props = OwnProps;
class BlockCreationTimeChart extends React.Component<Props> {
            ...
            <div className="chart-container">
                <div className="chart">
                    <div className="header-part">
                        <h2 className="title">Block creation time</h2>
                    </div>
    ...
    private renderBarChart() {
        ...
        const data =
            blocks.length < 2
                ? []
                : _.range(0, blocks.length - 1)
                      .map(i => {
                          return {
                              creationTime: blocks[i].timestamp - blocks[i + 1].timestamp,
                              blockNumber: blocks[i].number.toString(),
                              color: "hsl(191, 95%, 42%)"
                          };
                      })
                      .reverse();
...
export default BlockCreationTimeChart;
